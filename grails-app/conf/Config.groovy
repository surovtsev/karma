...
println("karma config locations:")
...
environments {
    development {
        ...
        grails.serverURL = "http://localhost:8080/karma"
    }
    production {
        grails.logging.jul.usebridge = false
        grails.serverURL = "http://karma/karma"
    }
}
...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'ru.sggr.karma.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'ru.sggr.karma.UserRole'
grails.plugins.springsecurity.authority.className = 'ru.sggr.karma.Role'
